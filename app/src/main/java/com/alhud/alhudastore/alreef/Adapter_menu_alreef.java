...
import com.alhud.alhudastore.riocafee.Adapter;
import com.bumptech.glide.Glide;

public class Adapter_menu_alreef extends RecyclerView.Adapter<Adapter_menu_alreef.ViewHolder>{
    ...
    Adapter_menu_alreef(Context context, String[] contents ){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.custom_view_menu_alreef,viewGroup,false);
