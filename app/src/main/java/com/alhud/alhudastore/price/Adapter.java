...
public class Adapter extends RecyclerView.Adapter<com.alhud.alhudastore.price.Adapter.ViewHolder> {
    ...
    Adapter(Context context, String[] contents ){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.custom_view_price,viewGroup,false);
