...
public class Adapter_menu_rio extends RecyclerView.Adapter<Adapter_menu_rio.ViewHolder> {
    ...
    Adapter_menu_rio(Context context, String[] contents ){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.custom_view_menu_rio,viewGroup,false);
