...
public class reports_table extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.table_reporrt);
        Bundle b=this.getIntent().getExtras();
        staiton_name = b.getStringArray("staiton_name");
        time = b.getStringArray("time");
        date = b.getStringArray("date");
        amount = b.getStringArray("amount");
    ...
    public void loadData() {
        ...
        int rows = staiton_name.length;
        getSupportActionBar().setTitle("fuel transaction  ");;
        ...
        for(int i = -1; i < rows; i ++) {
            ...
            if (i == -1) {
                tv2.setText("Station Name ");
                tv2.setBackgroundColor(Color.parseColor("#f7f7f7"));
            }else {
                tv2.setBackgroundColor(Color.parseColor("#ffffff"));
                tv2.setTextColor(Color.parseColor("#000000"));
                tv2.setText(staiton_name[i]);
            }
